  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-base font-medium text-black">Election Display Section</h2>
        <button
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            value={landingContent.callToAction.electionStatusFilter || "ongoing_completed"}
            onChange={(e) => updateCTA('electionStatusFilter', e.target.value)}
            className="w-full px-3 py-2 border rounded-md text-black"
          >
            <option value="ongoing_completed">Ongoing & Completed Only</option>
            <option value="all">All Statuses (Ongoing, Upcoming, Completed)</option>
          </select>
          <p className="text-xs text-gray-600 mt-1">
            Choose which election statuses to display on the landing page
          </p>
        </div>

        {/* Show Elections Toggle */}
        <div className="flex items-center">
          <input
            type="checkbox"
            id="show-elections"
            checked={landingContent.callToAction.showElections !== false}
            onChange={(e) => updateCTA('showElections', e.target.checked)}
            className="h-4 w-4 rounded border-gray-300 text-blue-600"
          />
          <label htmlFor="show-elections" className="ml-2 text-sm text-black">
            Display elections in the "Ready to Vote" section
          </label>
        </div>
